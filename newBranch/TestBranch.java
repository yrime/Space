...
public class TestBranch {
	...
	public static void main(String[] args) {
		...
		corps.get(0).setPosition(new Vector(10.0, 0.0, 0.0));
		corps.get(0).setVitesse(new Vector(0.0, 6.5, 0.0));
		
		corps.get(1).setMass(2000);
		corps.get(1).setRad(20.0);
		corps.get(1).setPosition(new Vector(70.0, 0.0, 0.0));
		corps.get(1).setVitesse(new Vector(0.0, 3.0, 0.0));
		
		corps.get(2).setMass(1500);
		corps.get(2).setRad(10.0);
		corps.get(2).setPosition(new Vector(40.0, 0.0, 0.0));
		corps.get(2).setVitesse(new Vector(0.0, 2.5, 0.0));
